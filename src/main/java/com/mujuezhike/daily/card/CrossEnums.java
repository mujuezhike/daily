...
public enum CrossEnums {
	...
	VOID_X_VOID            (0,0,"50%虚空  50%元素",                   		new int[]{0,0,0,0,0,1,2,3,4,5}),
	VOID_X_WATER           (0,1,"60%虚空  20%特定元素  10%光明 10%黑暗",		new int[]{0,0,0,0,0,0,1,1,7,8}),
	VOID_X_FIRE            (0,2,"60%虚空  20%特定元素  10%光明 10%黑暗",		new int[]{0,0,0,0,0,0,2,2,7,8}),
	VOID_X_EARTH           (0,3,"60%虚空  20%特定元素  10%光明 10%黑暗",		new int[]{0,0,0,0,0,0,3,3,7,8}),
	VOID_X_TREE            (0,4,"60%虚空  20%特定元素  10%光明 10%黑暗",		new int[]{0,0,0,0,0,0,4,4,7,8}),
	VOID_X_WIND            (0,5,"60%虚空  20%特定元素  10%光明 10%黑暗",		new int[]{0,0,0,0,0,0,5,5,7,8}),
	...
	WATER_X_FIRE           (1,2,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,1,2,6}),
	WATER_X_EARTH          (1,3,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,1,3,6}),
	WATER_X_TREE           (1,4,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,1,4,6}),
	WATER_X_WIND           (1,5,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,1,5,6}),
	...
	FIRE_X_EARTH           (2,3,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,2,3,6}),
	FIRE_X_TREE            (2,4,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,2,4,6}),
	FIRE_X_WIND            (2,5,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,2,5,6}),
	...
	EARTH_X_TREE           (3,4,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,3,4,6}),
	EARTH_X_WIND           (3,5,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,3,5,6}),
	...
	TREE_X_WIND            (4,5,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,4,5,6}),
	...
	WIND_X_WIND            (5,5,"70%虚空  10%特定元素1 10%特定元素2 10%金属", new int[]{0,0,0,0,0,0,0,4,5,6}),
	...
	public CrossEnums findByCode(int code1,int code2){
		...
		CrossEnums[] crosses = this.values();
