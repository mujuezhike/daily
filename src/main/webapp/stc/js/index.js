(function(){
    ...
    function addpointListeners(){
    	...
    	canvas.onmousemove = function(e){  
    		...
    		if(e.clientX >= 389 && e.clientX <= 981 
    	...
    	canvas.onclick = function(e){
    		...
    		if(e.clientX >= 389 && e.clientX <= 981 
    			...
    			window.location.href='./stc/techword.html?id='+ parseInt(Math.random()*50);
    ...
    function initStages() {
        ...
        stage.canvas.width = window.innerWidth-7;
        stage.canvas.height = window.innerHeight-7;
    }
